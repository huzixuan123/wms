...
<script type="text/javascript">
	$(function(){
		...
		$(".btn_input").click(function(){
			window.location.href="/stockIncomeBill/input.do";
		});
...
<body>
	<form id="searchForm" action="/stockIncomeBill/list.do" method="post">
		<div id="container">
			...
			<div class="ui_content">
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" bstockIncome="0">
						<tr>
							...
							<c:forEach items="${pageResult.list}" var="item">
								<tr>
									...
									<td>
										...
										<a href="javascript:;" class="btn_delete" data-url="/stockIncomeBill/delete.do?id=${item.id}">删除</a>
										<a href="javascript:;" class="btn_audit" data-url="/stockIncomeBill/audit.do?auditId=${item.id}">审核</a>
									</td>
									</c:if>
