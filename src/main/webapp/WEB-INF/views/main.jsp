...
<head>
	...
	<script type="text/javascript" src="/js/plugins/zTree/jquery.ztree.core-3.4.min.js"></script>
	<script type="text/javascript" src="/js/plugins/zTree/zTreeStyle.css"></script>
</head>
<body>
    <div id="top">
		<div id="top_logo">
    ...
    <div id="main">
      	<iframe name="right" id="rightMain" src="/employee/list.do" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
    </div>
</body>
</html>
