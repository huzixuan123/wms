...
<script type="text/javascript">
	$(function(){
		...
		//下拉列表回显
		$("#supplierId option[value=${orderBill.supplier.id}]").prop("selected",true);
	})
</script>
</head>
<body>
			...
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						...
						<input type="text" name="vdate" value="<fmt:formatDate value="${orderBill.vdate}" pattern="yyyy-MM-dd"/>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
