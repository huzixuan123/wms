		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" bstockIncome="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<select id="clients" name="client.id" class="ui_select01">
				...
				<tr>
					...
					<td class="ui_text_lt">
						...
						<input type="text" name="vdate" value="<fmt:formatDate value="${stockOutcomeBill.vdate}" pattern="yyyy-MM-dd"/>" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
