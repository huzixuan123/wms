...
<script type="text/javascript">
	$(function(){
		...
		$(".btn_input").click(function(){
			window.location.href="/stockOutcomeBill/input.do";
		});
							...
							<c:forEach items="${pageResult.list}" var="item">
								<tr>
									...
									<td>
										...
										<a href="javascript:;" class="btn_audit" data-url="/stockOutcomeBill/audit.do?auditId=${item.id}">审核</a>
									</td>
									</c:if>
