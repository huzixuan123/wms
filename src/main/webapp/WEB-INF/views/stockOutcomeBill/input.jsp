...
<script type="text/javascript">
    $(function () {
        ...
        $("input[tag=salePrice],input[tag=number]").blur(function () {
            var currentTr = $(this).closest("tr");
            var salePrice = parseFloat(currentTr.find("[tag=salePrice]").val());
...
<script type="text/javascript">
    $(function(){
        //下拉列表的回显
        $("#depotId option[value=${stockOutcomeBill.depot.id}]").prop("selected",true);
        $("#clientId option[value=${stockOutcomeBill.client.id}]").prop("selected",true);
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" bstockOutcome="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select id="clientId" name="client.id" class="ui_select01">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <input type="text" name="vdate"
                               value="<fmt:formatDate value="${stockOutcomeBill.vdate}" pattern="yyyy-MM-dd"/>"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" bstockOutcome="0" style="width: auto">
                            <thead>
                            <tr>
                                <th width="10"></th>
                                <th width="200">货品</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input disabled="true" readonly="true" class="ui_input_txt02"
                                                   ...
                                                   tag="name"/>
                                            <img src="/images/common/search.png" class="searchproduct"/>
                                            <input type="hidden" name="items[0].product.id" value="${item.product.id}"
                                                   tag="pid"/>
                                        </td>
